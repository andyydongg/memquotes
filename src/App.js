...
export default function MovieQuotesTracker() {
  const [quotes, setQuotes] = useState([
    ...
    },
    {
      ...
      length: "",
      timestamp: "",
      quote: "萧炎，你要知道年少轻狂的岁月，沉淀下来的是那些再也回不到的过去。而总让人感叹的，则是未曾珍惜而失去的那些。而这些恰恰也是我们想让你去体会的，因为年少轻狂的岁月，一生也只有一次。世间最珍贵的不是得不到和已失去的而是现在能把握的，我们生活在一个复杂而又充满无奈的世界，身上背负了太多太多的责任和使命，有时我们处理不当就会不堪重负难以忍受。最宽阔的是海洋，比海洋更宽阔的是天空，比天空更宽阔的是人的胸怀。当你紧握双手，里面什么也没有，当你打开双手，世界就在你手中",
    ...
    },
    {
      ...
      length: "112 min",
      timestamp: "0:33:43",
      quote: "[Why are people interested in art?] It's the trace of our passage on this earth.",
